...
MODEL     = Reaching
TARGET      = sfun
MODULE_SRCS   = c1_Reaching.c half_type.c
MODEL_SRC  = Reaching_sfun.c
MODEL_REG = Reaching_sfun_registry.c
MAKEFILE    = Reaching_sfun.mak
...
USER_INCLUDES   =  /I "C:\Users\valen\OneDrive - unige.it\Documenti\MATLAB\Biomedical Robotics\Assignment 3\Starting Files"
AUX_INCLUDES   = 
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\valen\OneDrive - unige.it\Documenti\MATLAB\Biomedical Robotics\Assignment 3\Starting Files\slprj\_sfprj\Reaching\_self\sfun\src" 
...
OBJLIST_FILE = Reaching_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
