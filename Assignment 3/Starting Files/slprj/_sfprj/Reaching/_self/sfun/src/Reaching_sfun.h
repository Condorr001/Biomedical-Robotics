#ifndef __Reaching_sfun_h__
#define __Reaching_sfun_h__
...
extern mxArray* load_Reaching_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_Reaching_optimization_info(void);
